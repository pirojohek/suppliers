...
CREATE TABLE storage.t_supplier_price
(
    c_id        SERIAL PRIMARY KEY,
    с_supplier  INTEGER REFERENCES storage.t_supplier (c_id) NOT NULL,
...
(
    ...
    c_supplier_price INTEGER REFERENCES storage.t_supplier_price(c_id) NOT NULL,
